                    ...
                    <a class="dropdown-item" href="javascript:void(0);">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                <span
                                    class="fw-semibold d-block">{{ session('firstname') . ' ' . session('lastname') }}</span>
                                <small class="text-muted">{{ ucfirst(session('user')) }}</small>
                            </div>
                        </div>
                    </a>
                </li>
                ...
                {{-- <li>
                    <a class="dropdown-item" href="javascript:void(0);">
                        <span class="d-flex align-items-center align-middle">
                            <i class="bx bx-credit-card me-2 pe-1 flex-shrink-0"></i>
